package com.jgerardo.fromzeroapi.iam.infrastructure.authorization.sfs.configuration;

import com.jgerardo.fromzeroapi.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.jgerardo.fromzeroapi.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.jgerardo.fromzeroapi.iam.infrastructure.tokens.jwt.BearerTokenService;
...
public class WebSecurityConfiguration{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(configurer -> configurer.configurationSource(req -> {
